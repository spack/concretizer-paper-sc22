...
class Mypackage(Package):
    ...
    variant("compression", default=True,
            description="Build with zlib compression support")
    ...
    def install(self, spec, prefix):
        ...
        if 'zlib' in spec:
            zlib_arg = '--with-zlib=%s' % spec['zlib'].prefix
        else:
            zlib_arg = '--without-zlib'
        config_args.append(zlib_arg)
