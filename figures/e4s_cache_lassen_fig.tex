...
\begin{figure*}[htb]
    ...
    \label{subfig:cdf_e4s_lassen_load}
        \includegraphics[width=\perfsubfigwidth\textwidth]{figures/perf/cdf_e4s_cache_lassen_setup_fig.pdf}
    }\hfill%
    \subfloat[][Solve times]{
    \label{subfig:cdf_e4s_lassen_solve}
        \includegraphics[width=\perfsubfigwidth\textwidth]{figures/perf/cdf_e4s_cache_lassen_solve_fig.pdf}
    }\hfill%
    \subfloat[][Total solver times]{
    \label{subfig:cdf_e4s_lassen_full}
        \includegraphics[width=\perfsubfigwidth\textwidth]{figures/perf/cdf_e4s_cache_lassen_total_fig.pdf}
    }
