...
\begin{figure*}[htb]
    ...
    \label{subfig:cdf_lassen_ground}
        \includegraphics[width=\perfsubfigwidth\textwidth]{figures/perf/cdf_lassen_ground_fig.pdf}
    }\hfill%
    \subfloat[][Solve times]{
    \label{subfig:cdf_lassen_solve}
        \includegraphics[width=\perfsubfigwidth\textwidth]{figures/perf/cdf_lassen_solve_fig.pdf}
    }\hfill%
    \subfloat[][Full solving times]{
    \label{subfig:cdf_lassen_full}
        \includegraphics[width=\perfsubfigwidth\textwidth]{figures/perf/cdf_lassen_total_fig.pdf}
    }
