...
\newcommand{\perfsubfigwidth}{0.26}
% \def{\perfsubfigwidth}{0.31}
\definecolor{bg}{rgb}{0.95,0.95,0.95}

\begin{document}

\title{Dependency Solving for Modern Software}
...
% For testing only - to be removed once citations are added in the content
\nocite{*}
%%%

\bibliographystyle{IEEEtran}
\bibliography{IEEEabrv,concretizer-paper-sc22}
